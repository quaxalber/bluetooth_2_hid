...
9.  Verify that the service is running:
    ...
    Dec 13 10:33:06 pi0w bluetooth_2_usb[5869]: 23-12-13 10:33:06 [INFO] Launching Bluetooth 2 USB v0.7.3-2
...
- When you interact with your Bluetooth devices with `-d` set, you should see debug output in the logs such as:
  ...
  23-12-15 13:16:01 [INFO] Launching Bluetooth 2 USB v0.7.3-2
